...
const companyDescription = `A total of $${totalRaised.toLocaleString()} has been raised for ${numGames} game${numGames === 1 ? '' : 's'}. ${numUnfunded} game${numUnfunded === 1 ? '' : 's'} remain unfunded. We need your help to fund these amazing projects!`;

// create a new DOM element containing the template string and append it to the description container
const descriptionElement = document.createElement("p");
descriptionElement.innerText = companyDescription;
...
console.log("Most Funded Game:", firstGame.name);
